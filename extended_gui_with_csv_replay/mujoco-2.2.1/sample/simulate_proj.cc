...
// projectile section of UI
const mjuiDef defProjectile[] = {
  {mjITEM_SECTION, "Projectile Game", 1, NULL, ""},
  {mjITEM_SLIDERINT, "X Velocity", 2, &settings.vel_x,  "-15 15"},
  {mjITEM_SLIDERINT, "Y Velocity", 2, &settings.vel_y,  "-15 15"},
  {mjITEM_BUTTON, "Launch", 1, NULL, ""},
  {mjITEM_BUTTON, "Reset", 1, NULL, ""},
  {mjITEM_END}
};
    ...
    // projectile section
      ...
      switch (it->itemid) {
        case 2: // Launch Button
          d->qvel[0] = settings.vel_x;
          d->qvel[2] = settings.vel_y;
          break;
        case 3: // Reset Button
          mj_resetData(m, d);
          break;
